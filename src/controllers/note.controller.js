...
const getNotes = asyncHandler(async (req, res) => {
  ...
  if (noteId) {
    ...
    return res.status(200).json(new ApiResponse(200, note, "Single note Successfully retrived"));
  }
  ...
  return res.status(200).json(new ApiResponse(200, notes, "Successfully retrived all Notes"));
});
